...
VSOutput VS(VSInput Input)
{
    ...
    float4 vEye = mul(inverseProjection, clipPos);
    float fogExponent = length(vEye.xyz) * fogDensity;
...
#ifdef DX9
PSSceneOut PS(float2 pos : VPOS, float fog : COLOR0)
{
    float2 fragPos = pos;
    float fogFactor = fog;
#else
